...
int __free(struct pcb_t *caller, int vmaid, int rgid)
{
  ...
  /* Create a new node for the free region list */
  rg_node = malloc(sizeof(struct vm_rg_struct));
  rg_node->rg_start = rg->rg_start;
  rg_node->rg_end = rg->rg_end;
...
int pg_getpage(struct mm_struct *mm, int pgn, int *fpn, struct pcb_t *caller)
{
  ...
  { /* Page is not online, make it actively living */
    ...
    /* Update page table */
    pte_set_swap(&pte, PAGING_PTE_SWPTYP_LOBIT, swpfpn);
...
int find_victim_page(struct mm_struct *mm, int *retpgn) 
{
  ...
  *retpgn = pg->pgn;
  ...
  /* Put the victim page to the end of the page list */
  pg->pg_next = NULL;
